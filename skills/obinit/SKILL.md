...
3. 读取 `AGENTS.md`、`CLAUDE.md`、`.agents/instructions.md`、`README.md` 和 `docs/`。
4. 只在 allowlist 内创建或更新：`AGENTS.md`、`CLAUDE.md`、`.agents/`、`docs/adr/`、`docs/superpowers/specs/`、`docs/superpowers/plans/`。
...
- 长期技术决策写入 `docs/adr/`。
- Superpowers spec/plan 保留原文件，memory 只链接。
...
公共知识必须通过关键词定向搜索和明确笔记读取来使用，不扫描整个 vault。
